"""
Sky map (Mollweide projection) functionality for Plotsar.
...
def make_skymap(
    ...
    samples : dict
        Raw samples dictionary (same dict passed to ``Plotsar``).
    show_pulsars : bool
    ...
    cw_sample_key : str, optional
        ...
        Plotsar auto-detects it by looking at the deterministic model name.
